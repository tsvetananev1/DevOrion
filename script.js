...
(function initI18n() {
    ...
    const translations = {
        bg: {
            ...
            'about.text1':  'DevOrion е екип от страстни дизайнери и програмисти, които вярват, че всеки бизнес заслужава изключително онлайн присъствие. Работим с модерните технологии и безкомпромисен подход към качеството.',
